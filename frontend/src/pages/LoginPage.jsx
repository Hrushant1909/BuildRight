...
function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex font-sans bg-slate-50">
      ...
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-900 p-12 flex-col justify-between relative overflow-hidden">
        {/* Abstract background shapes */}
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden opacity-20 pointer-events-none">
          <div className="absolute -top-24 -left-24 w-96 h-96 rounded-full bg-blue-500 blur-3xl"></div>
          <div className="absolute bottom-12 right-12 w-80 h-80 rounded-full bg-purple-500 blur-3xl"></div>
        </div>
        ...
        <div className="relative z-10 max-w-md">
          <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight mb-6">
            Welcome back to the construction future.
          </h1>
          <p className="text-indigo-200 text-lg leading-relaxed">
            Manage your projects, track your inquiries, and keep everything under control from one single, powerful platform.
          </p>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 md:p-12 relative overflow-hidden bg-slate-50 relative">
        ...
        <div className="lg:hidden absolute top-0 left-0 w-full h-64 bg-gradient-to-br from-blue-900 to-indigo-900 rounded-b-3xl"></div>
          ...
          <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-xl border border-slate-100 p-8 md:p-10 transition-all duration-300 hover:shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="group relative w-full flex justify-center py-3.5 px-4 rounded-xl border border-transparent text-sm font-bold text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 focus:outline-none focus:ring-4 focus:ring-blue-500/20 disabled:opacity-70 disabled:cursor-not-allowed transition-all duration-300 shadow-lg shadow-blue-600/20"
              >
                {loading ? (
